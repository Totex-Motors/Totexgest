...
const RastreamentoLeads = React.lazy(() => import("./pages/RastreamentoLeads"));
      ...
      <Route path="/comercial/treinamento" element={
        <ProtectedRoute>
          <RoleRoute allow={["admin", "comercial", "closer", "sdr"]}>
            <React.Suspense fallback={<div className="min-h-screen flex items-center justify-center text-sm text-muted-foreground">Carregando treinamento…</div>}>
              <CommercialTraining />
            </React.Suspense>
          </RoleRoute>
        </ProtectedRoute>
