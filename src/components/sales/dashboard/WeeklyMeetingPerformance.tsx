          ...
          <div className="space-y-4">
            ...
            {summary && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                ...
                <div className="rounded-lg bg-teal-50 dark:bg-teal-950/30 p-2.5 text-center">
                  <div className="flex items-center justify-center gap-1">
                    <Flame className="h-4 w-4 text-teal-500" />
                    <p className="text-lg font-bold text-teal-600 dark:text-teal-400">{summary.hotCount}</p>
                  </div>
                  <p className="text-[9px] text-teal-500/70">Leads quentes</p>
                </div>
              </div>
            )}
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-1.5">
                                ...
                                {m.is_hot && <Flame className="h-3 w-3 text-teal-500 shrink-0" />}
                                {selectedCloser === '_all' && (
