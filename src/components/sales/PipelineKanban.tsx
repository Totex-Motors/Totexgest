...
const stageColors: Record<string, { bg: string; dot: string; text: string }> = {
  ...
  orange: { bg: "bg-teal-50", dot: "bg-teal-500", text: "text-teal-600" },
    ...
    <TooltipProvider>
      <div
        ...
        className={cn(
          ...
          // Verde claro para estágios de ação quando OK
      ...
      >
        ...
        {/* Move to stage button (visible on mobile + hover on desktop) */}
        ...
        <div className="flex items-start gap-2 mb-2">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1">
              ...
              {isNewDeal && (
                <Badge className="h-4 px-1.5 text-[9px] font-bold bg-teal-500 text-white border-0 flex-shrink-0 animate-pulse">
                  NOVO
                </Badge>
              )}
            </div>
