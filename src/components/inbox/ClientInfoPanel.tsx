                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      {[
                        ...
                        <div key={label} className="flex items-center justify-between text-xs px-2 py-1.5 rounded-md bg-teal-50/50 border border-teal-200/40">
                          <span className="text-muted-foreground">{label}</span>
                          <span className="font-medium text-teal-800 truncate ml-2 max-w-[120px]">{value}</span>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        <DialogContent className="w-[420px] max-w-[90vw] max-h-[85vh] overflow-y-auto z-[200]">
          ...
          <div className="space-y-3">
            ...
            {searchStatus === "not_found" && (
              <div className="p-3 rounded-lg border border-teal-200 bg-teal-50/50 space-y-2.5">
                <div className="flex items-center gap-1.5">
                  <AlertCircle className="h-3.5 w-3.5 text-teal-600" />
                  <span className="text-xs font-semibold text-teal-700">Não encontrado — criar novo</span>
                </div>
