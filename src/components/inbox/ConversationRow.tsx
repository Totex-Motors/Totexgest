...
export function ConversationRow({
  ...
  else if (needsFollowUp) bgColor = "bg-teal-50 hover:bg-teal-100";
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1 mt-1 flex-wrap">
              ...
              {needsFollowUp && (
                <span className="text-[10px] px-1.5 py-0.5 rounded font-medium bg-teal-200 text-teal-800 flex items-center gap-0.5">
