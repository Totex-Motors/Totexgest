...
DROP FUNCTION IF EXISTS public.get_ai_agent_status_for_lead(uuid) CASCADE;
...
DO $$ BEGIN
  CREATE POLICY "tenant_isolation" ON public.config USING (true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

INSERT INTO config(key, value, updated_at)
VALUES ('SUPABASE_PROJECT_URL', 'https://mztfyavuclqzivywkaeu.supabase.co', NOW())
